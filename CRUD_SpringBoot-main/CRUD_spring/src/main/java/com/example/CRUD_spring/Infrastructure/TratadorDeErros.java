package com.example.CRUD_spring.Infrastructure;
...
public class TratadorDeErros {
    ...
    // Entidade não encontrada (ex: buscar por ID inexistente)
    ...
    // Erros de negócio (lançados manualmente ex: “Inserir CPF já cadastrado”)
